...
filtered_behavioural_data_sequence = behavioural_data[(behavioural_data['beh'] == preceding_event) & (behavioural_data['beh_after'].isin(postceding_event)) & (behavioural_data['delay'] <= max_delay_frames)]
