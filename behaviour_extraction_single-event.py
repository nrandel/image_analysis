...
# Export the DataFrame to a CSV file
''' Add timerange to file name '''
event_time_ranges_df.to_csv('/Users/nadine/Documents/paper/single-larva/generated-data/Fluorescence-traces/alliged_behaviour/F-Decision-60_20TP.csv', index=False)
...
event_time_ranges_df = pd.read_csv('/Users/nadine/Documents/paper/single-larva/generated-data/Fluorescence-traces/alliged_behaviour/F-Decision-60_20TP.csv', converters={'Time_Points_Range': ast.literal_eval})
...
# Save the result to a new CSV file
result_df.to_csv('/Users/nadine/Documents/paper/single-larva/ACardona_dff-file/final_output_F-Decision-60_20TP-ClemClam.csv', index=False)
