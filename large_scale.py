...
#%%
# Find intersection between neurons that respond to first and sec stimulus/ behaviour 
# for sliding window and my dff

# Input: responsive_neurons_sd_XXX_average_ACTION
# Output: intersection_responsive_neurons_sd_XXX_average_ACTION (csv neurons that responds to two events)
...
# %%
# Use this from now on for MY dff from raw data
...
# dff 
df = pd.read_csv('/Users/nadine/Documents/paper/single-larva/behavior_extraction/dff/output_dff_HP_46.csv')
...
save_neurons_to_csv(responsive_neurons_peak, "HP_responsive_neurons_sd_2_peak_46.csv", path=save_dir)
save_neurons_to_csv(responsive_neurons_average, "HP_responsive_neurons_sd_2_average_46.csv", path=save_dir)
...
df_responsive_neurons_peak.to_csv(os.path.join(save_dir, "HP_activity_of_responsive_neurons_sd_2_peak_46.csv"), index=False)
df_responsive_neurons_average.to_csv(os.path.join(save_dir, "HP_activity_of_responsive_neurons_sd_2_average_46.csv"), index=False)
